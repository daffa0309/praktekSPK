    ...
    <form method="post">
      <div class="row">
        <div class="col-md-6 text-left">
          <strong style="font-size:18pt;"><span class="fa fa-modx"></span> Data Barang</strong>
        </div>
        <div class="col-md-6 text-right">
          <div class="btn-group">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><span class="fa fa-clone"></span> Tambah Data</button>
        ...
        <tbody>
          ...
          ?>
            ...
            <tr>
              ...
              <td> <button type="button" data-toggle="modal" data-target="#edit<?= $idb; ?>" class="btn btn-warning"><span class="fa fa-clone"></span> Edit Data</button><button type="button" data-toggle="modal" data-target="#del<?= $idb; ?>" class="btn btn-danger"><span class="fa fa-clone"></span> Hapus Data</button>
              </td>
            </tr>
