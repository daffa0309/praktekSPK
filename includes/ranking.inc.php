...
class Ranking
{
	...
	function readKhusus()
	{
		...
		$query = "SELECT * FROM data_alternatif a, data_kriteria b, ranking c where a.id_alternatif=c.alternatif and b.id_kriteria=c.kriteria order by a.id_alternatif asc";
		$stmt = $this->conn->prepare($query);
		$stmt->execute();
