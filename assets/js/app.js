...
function showNoticeToast() {
  $().toastmessage(
    "showNoticeToast",
    "Kami telah menentukan nilai yang boleh diinput"
  );
}
...
function showWarningToast() {
  $().toastmessage(
    "showWarningToast",
    "Peringatan, password anda masukkan salah"
  );
}
...
function showErrorToast() {
  $().toastmessage(
    "showErrorToast",
    "Data gagal dihapus, (hapus dulu data yang terkait pada menu lainnya)"
  );
}
